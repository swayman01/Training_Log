...
post_modify_workout_variables = require('./../routes/post_modify_workout')
DEBUG = global_constants.DEBUG
INTERVAL_TIME = global_constants.INTERVAL_TIME
workoutGLOBAL = post_modify_workout_variables.workoutGLOBAL
db = global_constants.db
if (DEBUG) console.log('loaded post_edit_workout.js', Date.now())
